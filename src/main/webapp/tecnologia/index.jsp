	...
	<body>
		...
		<section>
			...
			<div id="fotos">
				...
				<ul>
					<li>
					<img alt="new1" src="img/olherao-3g-wifi.jpg">
					<div class="barra_semi-transparente">
						<p><a href="../tecnologia/olherao-3g-wifi.jsp"><b>Começam a ser produzidos orelhões 3G</b>
						<br>Parar tentar evitar desaparecimento, tecnologia é absorvida por aparelhos.
						Por dia, cerca de 120 orelhões, em média, somem das ruas do país.</a></p>
					</div>
					</li>
					...
					<img alt="new1" src="img/olherao-3g-wifi.jpg">
					<div class="barra_semi-transparente">
						<p><a href="../tecnologia/olherao-3g-wifi.jsp"><b>Começam a ser produzidos orelhões 3GG</b>
						<br>Parar tentar evitar desaparecimento, tecnologia é absorvida por aparelhos.
						Por dia, cerca de 120 orelhões, em média, somem das ruas do país.</a></p>
					</div>
					</li>
			...
			<ul>
				...
				<a href="../tecnologia/olherao-3g-wifi.jsp"><img src="img/olherao-3g-wifi.jpg" width="155" height="110">
		...
		<aside>
			...
			<div class="maisLidas">
				...
				<ol class="setaMaisLidas">
					...
					<li><img alt="" src="../img/logos/seta.png"><a href="../tecnologia/olherao-3g-wifi.jsp">Começam a ser produzidos alguns orelhões com tecnlogia 3G</a></li>
					<li><img alt="" src="../img/logos/seta.png"><a href="../tecnologia/olherao-3g-wifi.jsp">Começam a ser produzidos alguns orelhões com tecnologia 3G</a></li>
					<li><img alt="" src="../img/logos/seta.png"><a href="../tecnologia/olherao-3g-wifi.jsp">Começam a ser produzidos alguns orelhões com tecnologia 3G</a></li>
					<li><img alt="" src="../img/logos/seta.png"><a href="../tecnologia/olherao-3g-wifi.jsp">Começam a ser produzidos alguns orelhões com tecnologia 3G</a></li>
				</ol>
			...
			<div class="videos">
				<b class="titleVideos">Videos</b>
				<ul>
					<li>
						<h3><a class="mostraVideo" href="#">Windows 8.1</a></h3>
						<div class="video" id="videoevidente">
							<iframe width="300" height="250" src="//www.youtube.com/embed/whFRzIq7um8"  allowfullscreen></iframe>
						</div>
					</li>
					<li>
