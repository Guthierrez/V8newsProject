<html lang="pt-br">
	...
	<body>
		<header>
			<img alt="logo" class="logo" src="../img/logos/logoVermelho.png">
		...
		<section>
			...
			<div id="fotos">
				...
				<ul>
					<li>
					<img alt="new1" src="img/professor-ufg-mit.jpg">
					<div class="barra_semi-transparente">
						<p><a href="../noticias/professor-ufg-mit.jsp"><b>MIT lista professor da UFG entre os dez brasileiros mais inovadores</b>
						<br>Pesquisador desenvolveu teste de baixíssimo custo para análises clínicas.
				Entidade dos EUA pré-selecionou projeto para disputa internacional.</a></p>
					</div>
					</li>
					...
					<img alt="new1" src="img/professor-ufg-mit.jpg">
					<div class="barra_semi-transparente">
						<p><a href="../noticas/professor-ufg-mit.jsp"><b>MIT lista professor da UFG entre os dez brasileiros mais inovadores</b>
						<br>Pesquisador desenvolveu teste de baixíssimo custo para análises clínicas.
				Entidade dos EUA pré-selecionou projeto para disputa internacional.</a></p>
					</div>
					</li>
			...
			<ul>
				...
				<a href="../noticias/professor-ufg-mit.jsp"><img src="img/professor-ufg-mit.jpg" width="155" height="110">
		...
		<aside>
			...
			<div class="videos">
				...
				<ul>
					<li>
						<h3><a class="mostraVideo" href="#">Tempo</a></h3>
						<div class="video" id="videoevidente">
							<iframe width="300" height="250" src="//www.youtube.com/embed/__RKmWB80nU"  allowfullscreen></iframe>
						</div>
					</li>
					<li>
