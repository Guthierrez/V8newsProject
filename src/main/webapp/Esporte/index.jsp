...
<html lang="pt-br">
	<head>
		<link rel="stylesheet" type="text/css" href="Esporte/css/esportes.css">
		<meta charset="utf-8">
		...
		<section>
			...
			<c:forEach items="${noticias}" var="noticia">
				<div class="maisNoticias">
					<h1 class="titleMaisNoticias"><b class="tituloEsportes">${noticia.categoria}</b></h1>
					...
					<ul>
						...
						<b class="tituloEsportes">${noticia.nome}</b><br>
