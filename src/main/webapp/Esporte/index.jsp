<html lang="pt-br">
	<head>
		<link rel="stylesheet" type="text/css" href="css/esportes.css">
		<meta charset="utf-8">
	...
	<body>
		<header>
			<img alt="logo" class="logo" src="../img/logos/logoVerde.png">
		...
		<section>
			...
			<div id="fotos">
				...
				<ul>
					<li>
					<img alt="new1" src="img/5-dores-quem-corre.jpg">
					<div class="barra_semi-transparente">
						<p><a href="../esportes/5-dores-quem-corre.jsp"><b>As cinco maiores dores de quem corre</b>
						<br>Atletas novatos estão acostumados e não sabem identificar gravidade das lesões causadas pela corrida. Especialista ajuda a lidar com problema.</a></p>
					</div>
					</li>
			...
			<ul>
				...
				<a href="../esportes/5-dores-quem-corre.jsp"><img src="img/5-dores-quem-corre.jpg" width="155" height="110">
		...
		<aside>
			...
			<div class="videos">
				...
				<ul>
					<li>
						<h3><a class="mostraVideo" href="#">Convocação</a></h3>
						<div class="video" id="videoevidente">
							<iframe width="300" height="250" src="//www.youtube.com/embed/pbHyMNvl8FI"  allowfullscreen></iframe>
						</div>
					</li>
					<li>
