	...
	<body>
		...
		<section>
			...
			<div id="fotos">
				...
				<ul>
					<li>
					<img alt="new1" src="img/saude-alimentos-coloridos.jpg">
					<div class="barra_semi-transparente">
						<p><a href="../variedades/saude-alimentos-coloridos.jsp"><b>Alimentos coloridos, tudo para uma alimentação balanceada</b>
						<br>Os legumes, as frutas e oleaginosas favorecem a manutenção da saúde além de formar um prato mais bonito e atrativo.</a></p>
					</div>
					</li>
			...
			<ul>
				...
				<a href="../variedades/saude-alimentos-coloridos.jsp"><img src="img/saude-alimentos-coloridos.jpg" width="155" height="110">
		...
		<aside>
			...
			<div class="videos">
				...
				<ul>
					<li>
						<h3><a class="mostraVideo" href="#">Culinária</a></h3>
						<div class="video" id="videoevidente">
							<iframe width="300" height="250" src="//www.youtube.com/embed/KDNqKd10bX8?list=UU1bpPvbeB-s3OLa9DoR4jxw"  allowfullscreen></iframe>
						</div>
					</li>
					<li>
